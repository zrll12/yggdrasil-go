...
func InitRouters(router *gin.Engine, db *gorm.DB, meta *ServerMeta, skinRootUrl string, requireCode bool) {
	...
	userService := service.NewUserService(tokenService, db, requireCode)
